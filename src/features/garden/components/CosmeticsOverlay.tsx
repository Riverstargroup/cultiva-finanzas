...
// Ported from the Mi Jardín prototype (garden-scene.jsx).
...
export function CosmeticsOverlay({ id, size = 40 }: CosmeticsOverlayProps): JSX.Element | null {
  if (id === 'sombrero') {
    return (
      <svg
        width={size}
        height={size * 0.8}
        viewBox="0 0 50 40"
        style={{ position: 'absolute', top: -size * 0.55, left: '50%', transform: 'translateX(-50%)' }}
      >
  ...
  if (id === 'birrete') {
    return (
      <svg
        ...
        height={size * 0.8}
        viewBox="0 0 55 40"
        style={{ position: 'absolute', top: -size * 0.65, left: '50%', transform: 'translateX(-50%)' }}
      >
  ...
  if (id === 'lentes') {
    return (
      <svg
        ...
        height={size * 0.5}
        viewBox="0 0 65 26"
        style={{ position: 'absolute', top: size * 0.12, left: '50%', transform: 'translateX(-50%)' }}
      >
  ...
  if (id === 'bufanda') {
    return (
      <svg
        ...
        height={size * 0.55}
        viewBox="0 0 70 28"
        style={{ position: 'absolute', top: size * 0.7, left: '50%', transform: 'translateX(-50%)' }}
      >
        <path
